...
try {
    PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM TEACHER_DB WHERE email = ? AND password = ?");
...
<body>
    ...
    <% if (success) { %>
        ...
        <a href="teacher_dashboard.jsp">Go to Dashboard</a>
    <% } else { %>
        <p>Invalid email or password. Please try again.</p>
        <a href="teacher_portal.jsp">Try Again</a>
    <% } %>
</body>
</html>
